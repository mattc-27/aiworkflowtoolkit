...
import "../style.css"; // shared primitives  ← :contentReference[oaicite:5]{index=5}
        ...
        <div className="json2s-grid">
          ...
          <div className="json2s-leftcol">
            <label className="label" htmlFor="spec">
              Describe your fields (one per line)
            </label>
            ...
            <div className="hint json2s-hint">
              Examples: <code>email: email</code>,{" "}
              <code>age: number min=0 max=120</code>,{" "}
              <code>role: enum(admin|editor|viewer)</code>,{" "}
              <code>tags: string optional</code>
            </div>
