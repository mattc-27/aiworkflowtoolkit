  ...
  <div className="tool">
    ...
    <div className="card tool-card tool-section">
      ...
      <div className="kv tool-section">
        <label><input type="checkbox" checked={aggressive} onChange={e=>setAggressive(e.target.checked)} /> Aggressive mode</label>
        <label><input type="checkbox" checked={alsoUseAsCompletion} onChange={e=>setAlsoUseAsCompletion(e.target.checked)} /> Use compressed as completion too</label>
      </div>
      ...
      <div className="help">Saved: <strong>{result.savedChars}</strong> chars (~{result.savedPercent}%).</div>
    </div>
  </div>
  );
}
